...
package Gdk.Event is
   ...
   type Gdk_Event is new Glib.C_Proxy;
   ...
   function Get_Window    (Event : Gdk_Event) return Gdk_Window;
   ...
   function Get_Subwindow (Event : Gdk_Event) return Gdk_Window;
   ...
   function Get_Requestor (Event : Gdk_Event) return Gdk_Window;
   --  ???
   ...
   procedure Set_Window (Event : Gdk_Event; Win : Gdk_Window);
   ...
   procedure Set_Subwindow (Event : Gdk_Event; Window : Gdk_Window);
