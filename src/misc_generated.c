...
void gtkada_Paintable_set_get_current_image(GdkPaintableInterface* iface, void* handler) {
    iface->get_current_image = handler;
}

void gtkada_Paintable_set_get_flags(GdkPaintableInterface* iface, void* handler) {
    iface->get_flags = handler;
}

void gtkada_Paintable_set_get_intrinsic_aspect_ratio(GdkPaintableInterface* iface, void* handler) {
    iface->get_intrinsic_aspect_ratio = handler;
}

void gtkada_Paintable_set_get_intrinsic_height(GdkPaintableInterface* iface, void* handler) {
    iface->get_intrinsic_height = handler;
}

void gtkada_Paintable_set_get_intrinsic_width(GdkPaintableInterface* iface, void* handler) {
    iface->get_intrinsic_width = handler;
}

void gtkada_Paintable_set_snapshot(GdkPaintableInterface* iface, void* handler) {
    iface->snapshot = handler;
}
