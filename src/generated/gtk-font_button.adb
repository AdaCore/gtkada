...
package body Gtk.Font_Button is
   ...
   is
      ...
      Stub_Pango_Font_Family : Pango.Font.Pango_Font_Family_Record;
      Stub_Pango_Font_Face   : Pango.Font.Pango_Font_Face_Record;
   begin
      return Boolean'Pos (Func (Pango.Font.Pango_Font_Family (Get_User_Data (Family, Stub_Pango_Font_Family)), Pango.Font.Pango_Font_Face (Get_User_Data (Face, Stub_Pango_Font_Face))));
   ...
   is
   begin
      C_Gtk_Font_Chooser_Set_Filter_Func (Get_Object (Self), Internal_Gtk_Font_Filter_Func'Address, Filter'Address, System.Null_Address);
   end Set_Filter_Func;
   ...
   package body Set_Filter_Func_User_Data is
      ...
      is
         ...
         Stub_Pango_Font_Face   : Pango.Font.Pango_Font_Face_Record;
      begin
         return Boolean'Pos (To_Gtk_Font_Filter_Func (D.Func) (Pango.Font.Pango_Font_Family (Get_User_Data (Family, Stub_Pango_Font_Family)), Pango.Font.Pango_Font_Face (Get_User_Data (Face, Stub_Pango_Font_Face)), D.Data.all));
      end Internal_Cb;
   ...
   is
      ...
      Stub_Pango_Font_Face : Pango.Font.Pango_Font_Face_Record;
   begin
      return Pango.Font.Pango_Font_Face (Get_User_Data (Internal (Get_Object (Self)), Stub_Pango_Font_Face));
   end Get_Font_Face;
   ...
   is
      ...
      Stub_Pango_Font_Family : Pango.Font.Pango_Font_Family_Record;
   begin
      return Pango.Font.Pango_Font_Family (Get_User_Data (Internal (Get_Object (Self)), Stub_Pango_Font_Family));
   end Get_Font_Family;
