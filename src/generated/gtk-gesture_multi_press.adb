...
package body Gtk.Gesture_Multi_Press is

   package Type_Conversion_Gtk_Gesture_Multi_Press is new Glib.Type_Conversion_Hooks.Hook_Registrator
     (Get_Type'Access, Gtk_Gesture_Multi_Press_Record);
   pragma Unreferenced (Type_Conversion_Gtk_Gesture_Multi_Press);
   ...
   is
      Self : constant Gtk_Gesture_Multi_Press := new Gtk_Gesture_Multi_Press_Record;
   begin
      Gtk.Gesture_Multi_Press.Initialize (Self, Widget);
      return Self;
   end Gtk_Gesture_Multi_Press_New;
   ...
   is
   begin
      Self := new Gtk_Gesture_Multi_Press_Record;
      Gtk.Gesture_Multi_Press.Initialize (Self, Widget);
   end Gtk_New;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_gesture_multi_press_new");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_gesture_multi_press_get_area");
   ...
   is
      procedure Internal
         (Self : System.Address;
          Rect : Gdk.Rectangle.Gdk_Rectangle);
      pragma Import (C, Internal, "gtk_gesture_multi_press_set_area");
   begin
   ...
   function Address_To_Cb is new Ada.Unchecked_Conversion
     (System.Address, Cb_Gtk_Gesture_Multi_Press_Gint_Gdouble_Gdouble_Void);
   ...
   function Cb_To_Address is new Ada.Unchecked_Conversion
     (Cb_Gtk_Gesture_Multi_Press_Void, System.Address);
   function Address_To_Cb is new Ada.Unchecked_Conversion
     (System.Address, Cb_Gtk_Gesture_Multi_Press_Void);
   ...
   procedure Connect
      (Object  : access Gtk_Gesture_Multi_Press_Record'Class;
       C_Name  : Glib.Signal_Name;
       Handler : Cb_Gtk_Gesture_Multi_Press_Gint_Gdouble_Gdouble_Void;
       After   : Boolean);

   procedure Connect
      (Object  : access Gtk_Gesture_Multi_Press_Record'Class;
       C_Name  : Glib.Signal_Name;
       Handler : Cb_Gtk_Gesture_Multi_Press_Void;
       After   : Boolean);
   ...
   procedure Marsh_Gtk_Gesture_Multi_Press_Gint_Gdouble_Gdouble_Void
      (Closure         : GClosure;
       Return_Value    : Glib.Values.GValue;
       N_Params        : Glib.Guint;
       Params          : Glib.Values.C_GValues;
       Invocation_Hint : System.Address;
       User_Data       : System.Address);
   pragma Convention (C, Marsh_Gtk_Gesture_Multi_Press_Gint_Gdouble_Gdouble_Void);

   procedure Marsh_Gtk_Gesture_Multi_Press_Void
      (Closure         : GClosure;
       Return_Value    : Glib.Values.GValue;
       N_Params        : Glib.Guint;
       Params          : Glib.Values.C_GValues;
       Invocation_Hint : System.Address;
       User_Data       : System.Address);
   pragma Convention (C, Marsh_Gtk_Gesture_Multi_Press_Void);
   ...
   begin
      Unchecked_Do_Signal_Connect
        (Object      => Object,
         C_Name      => C_Name,
         Marshaller  => Marsh_Gtk_Gesture_Multi_Press_Gint_Gdouble_Gdouble_Void'Access,
   ...
   begin
      Unchecked_Do_Signal_Connect
        (Object      => Object,
         C_Name      => C_Name,
         Marshaller  => Marsh_Gtk_Gesture_Multi_Press_Void'Access,
         Handler     => Cb_To_Address (Handler),--  Set in the closure
         After       => After);
   end Connect;
   ...
   -------------------------------------------------------------
   -- Marsh_Gtk_Gesture_Multi_Press_Gint_Gdouble_Gdouble_Void --
   -------------------------------------------------------------
   ...
   is
      pragma Unreferenced (Return_Value, N_Params, Invocation_Hint, User_Data);
      H   : constant Cb_Gtk_Gesture_Multi_Press_Gint_Gdouble_Gdouble_Void := Address_To_Cb (Get_Callback (Closure));
      Obj : constant Gtk_Gesture_Multi_Press := Gtk_Gesture_Multi_Press (Unchecked_To_Object (Params, 0));
   begin
      H (Obj, Unchecked_To_Gint (Params, 1), Unchecked_To_Gdouble (Params, 2), Unchecked_To_Gdouble (Params, 3));
      exception when E : others => Process_Exception (E);
   end Marsh_Gtk_Gesture_Multi_Press_Gint_Gdouble_Gdouble_Void;
   ...
   is
      pragma Unreferenced (Return_Value, N_Params, Invocation_Hint, User_Data);
      H   : constant Cb_Gtk_Gesture_Multi_Press_Void := Address_To_Cb (Get_Callback (Closure));
      Obj : constant Gtk_Gesture_Multi_Press := Gtk_Gesture_Multi_Press (Unchecked_To_Object (Params, 0));
   begin
      H (Obj);
      exception when E : others => Process_Exception (E);
   end Marsh_Gtk_Gesture_Multi_Press_Void;
