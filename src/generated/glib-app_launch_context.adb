...
package body Glib.App_Launch_Context is
   ...
   function Cb_To_Address is new Ada.Unchecked_Conversion
     (Cb_GObject_Gapp_Info_Gvariant_Void, System.Address);
   function Address_To_Cb is new Ada.Unchecked_Conversion
     (System.Address, Cb_GObject_Gapp_Info_Gvariant_Void);
   ...
   pragma Convention (C, Marsh_GObject_Gapp_Info_Gvariant_Void);
   ...
   procedure Marsh_Gapp_Launch_Context_Gapp_Info_Gvariant_Void
      (Closure         : GClosure;
       ...
       Invocation_Hint : System.Address;
       User_Data       : System.Address);
   pragma Convention (C, Marsh_Gapp_Launch_Context_Gapp_Info_Gvariant_Void);
   ...
   begin
      Unchecked_Do_Signal_Connect
        (Object      => Object,
         C_Name      => C_Name,
         Marshaller  => Marsh_Gapp_Launch_Context_Gapp_Info_Gvariant_Void'Access,
         Handler     => Cb_To_Address (Handler),--  Set in the closure
         After       => After);
   end Connect;
   ...
   begin
      Unchecked_Do_Signal_Connect
        (Object      => Object,
         C_Name      => C_Name,
         Marshaller  => Marsh_GObject_Gapp_Info_Gvariant_Void'Access,
         Handler     => Cb_To_Address (Handler),--  Set in the closure
         Slot_Object => Slot,
         After       => After);
   end Connect_Slot;
   ...
   is
      ...
      H   : constant Cb_GObject_Gapp_Info_Gvariant_Void := Address_To_Cb (Get_Callback (Closure));
   ...
   end Marsh_GObject_Gapp_Info_Gvariant_Void;
   ...
   is
      pragma Unreferenced (Return_Value, N_Params, Invocation_Hint, User_Data);
      H   : constant Cb_Gapp_Launch_Context_Gapp_Info_Gvariant_Void := Address_To_Cb (Get_Callback (Closure));
      Obj : constant Gapp_Launch_Context := Gapp_Launch_Context (Unchecked_To_Object (Params, 0));
   begin
      H (Obj, Glib.App_Info.Gapp_Info (Unchecked_To_Interface (Params, 1)), Glib.Variant.From_Object (Unchecked_To_Address (Params, 2)));
   exception
      when E : others => Process_Exception (E);
   end Marsh_Gapp_Launch_Context_Gapp_Info_Gvariant_Void;
   ...
   is
   begin
      Connect (Self, "launched" & ASCII.NUL, Call, After);
   end On_Launched;
   ...
   is
   begin
      Connect_Slot (Self, "launched" & ASCII.NUL, Call, After, Slot);
   end On_Launched;
