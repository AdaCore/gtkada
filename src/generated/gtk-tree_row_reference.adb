...
package body Gtk.Tree_Row_Reference is
   ...
   begin
      Self.Set_Object (Internal (Model, Get_Object (Path)));
   end Gtk_New;
   ...
   begin
      Self.Set_Object (Internal (Get_Object (Proxy), Model, Get_Object (Path)));
   end Gtk_New_Proxy;
   ...
   procedure Free (Self : Gtk_Tree_Row_Reference) is
   ...
   function Valid (Self : Gtk_Tree_Row_Reference) return Boolean is
