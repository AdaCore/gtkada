...
package body Gtk.Editable is
   ...
   begin
      return Gtkada.Bindings.Value_And_Free (Internal (Self, Start_Pos, End_Pos));
   end Get_Chars;
   ...
   function Get_Editable (Self : Gtk_Editable) return Boolean is
      function Internal (Self : Gtk_Editable) return Glib.Gboolean;
   ...
   function Get_Enable_Undo (Self : Gtk_Editable) return Boolean is
      function Internal (Self : Gtk_Editable) return Glib.Gboolean;
   ...
   begin
      Tmp_Return := Internal (Self, Acc_Start_Pos'Access, Acc_End_Pos'Access);
   ...
   function Get_Text (Self : Gtk_Editable) return UTF8_String is
      function Internal (Self : Gtk_Editable) return Gtkada.Types.Chars_Ptr;
   ...
   begin
      Internal (Self, Tmp_Text, Length, Position);
      Free (Tmp_Text);
   end Insert_Text;
   ...
   procedure Set_Editable (Self : Gtk_Editable; Is_Editable : Boolean) is
      procedure Internal (Self : Gtk_Editable; Is_Editable : Glib.Gboolean);
   ...
   procedure Set_Enable_Undo (Self : Gtk_Editable; Enable_Undo : Boolean) is
      procedure Internal (Self : Gtk_Editable; Enable_Undo : Glib.Gboolean);
      pragma Import (C, Internal, "gtk_editable_set_enable_undo");
   begin
      Internal (Self, Boolean'Pos (Enable_Undo));
   end Set_Enable_Undo;
   ...
   procedure Set_Text (Self : Gtk_Editable; Text : UTF8_String) is
      procedure Internal
         (Self : Gtk_Editable;
          Text : Gtkada.Types.Chars_Ptr);
   ...
   is
      function Internal
         (Object    : System.Address;
          ...
          Acc_Pspec : access Glib.Param_Spec) return Glib.Gboolean;
      pragma Import (C, Internal, "gtk_editable_delegate_get_property");
      Acc_Value  : aliased Glib.Values.GValue := Value;
      Acc_Pspec  : aliased Glib.Param_Spec := Pspec;
      Tmp_Return : Glib.Gboolean;
   begin
      Tmp_Return := Internal (Get_Object (Object), Prop_Id, Acc_Value'Access, Acc_Pspec'Access);
      Value := Acc_Value;
      Pspec := Acc_Pspec;
      return Tmp_Return /= 0;
   end Delegate_Get_Property;
   ...
   is
      function Internal
         (Object    : System.Address;
          ...
          Acc_Value : access Glib.Values.GValue;
          Acc_Pspec : access Glib.Param_Spec) return Glib.Gboolean;
      pragma Import (C, Internal, "gtk_editable_delegate_set_property");
      Acc_Value  : aliased Glib.Values.GValue := Value;
      Acc_Pspec  : aliased Glib.Param_Spec := Pspec;
      Tmp_Return : Glib.Gboolean;
   begin
