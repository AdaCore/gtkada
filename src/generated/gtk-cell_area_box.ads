...
--  the `GtkCellAreaBox` is oriented in the Gtk.Enums.Orientation_Vertical
--  orientation, the start is defined as the top of the box and the end is
--  defined as the bottom. In the Gtk.Enums.Orientation_Horizontal orientation
...
--  with Gtk.Cell_Area.Cell_Set_Property or by specifying the "align" argument
--  to Gtk.Cell_Area_Box.Pack_Start and Gtk.Cell_Area_Box.Pack_End.
...
package Gtk.Cell_Area_Box is
   ...
   package Set_Cell_Data_Func_User_Data is
      ...
      procedure Set_Cell_Data_Func
         (Self      : not null access Gtk.Cell_Area_Box.Gtk_Cell_Area_Box_Record'Class;
          Cell      : not null access Gtk.Cell_Renderer.Gtk_Cell_Renderer_Record'Class;
          Func      : Gtk_Cell_Layout_Data_Func;
   ...
   procedure Clear (Self : not null access Gtk_Cell_Area_Box_Record);
