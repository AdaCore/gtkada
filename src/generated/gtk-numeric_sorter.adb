...
package body Gtk.Numeric_Sorter is

   package Type_Conversion_Gtk_Numeric_Sorter is new Glib.Type_Conversion_Hooks.Hook_Registrator
     (Get_Type'Access, Gtk_Numeric_Sorter_Record);
   pragma Unreferenced (Type_Conversion_Gtk_Numeric_Sorter);
   ...
   is
   begin
      Self := new Gtk_Numeric_Sorter_Record;
      Gtk.Numeric_Sorter.Initialize (Self, Expression);
   end Gtk_New;
   ...
   is
      Self : constant Gtk_Numeric_Sorter := new Gtk_Numeric_Sorter_Record;
   begin
      Gtk.Numeric_Sorter.Initialize (Self, Expression);
      return Self;
   end Gtk_Numeric_Sorter_New;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_numeric_sorter_new");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_numeric_sorter_get_expression");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_numeric_sorter_get_sort_order");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_numeric_sorter_set_expression");
   begin
   ...
   is
      procedure Internal
         (Self       : System.Address;
          Sort_Order : Gtk.Enums.Gtk_Sort_Type);
      pragma Import (C, Internal, "gtk_numeric_sorter_set_sort_order");
   begin
