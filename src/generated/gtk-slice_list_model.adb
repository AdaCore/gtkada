...
package body Gtk.Slice_List_Model is

   package Type_Conversion_Gtk_Slice_List_Model is new Glib.Type_Conversion_Hooks.Hook_Registrator
     (Get_Type'Access, Gtk_Slice_List_Model_Record);
   pragma Unreferenced (Type_Conversion_Gtk_Slice_List_Model);
   ...
   is
   begin
      Self := new Gtk_Slice_List_Model_Record;
      Gtk.Slice_List_Model.Initialize (Self, Model, Offset, Size);
   end Gtk_New;
   ...
   is
      Self : constant Gtk_Slice_List_Model := new Gtk_Slice_List_Model_Record;
   begin
      Gtk.Slice_List_Model.Initialize (Self, Model, Offset, Size);
      return Self;
   end Gtk_Slice_List_Model_New;
   ...
   is
      function Internal
         (Model  : Glib.List_Model.Glist_Model;
          Offset : Guint;
          Size   : Guint) return System.Address;
      pragma Import (C, Internal, "gtk_slice_list_model_new");
   begin
      if not Self.Is_Created then
         Set_Object (Self, Internal (Model, Offset, Size));
      end if;
   end Initialize;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_slice_list_model_get_model");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_slice_list_model_get_offset");
   begin
      return Internal (Get_Object (Self));
   end Get_Offset;
   ...
   is
      function Internal (Self : System.Address) return Guint;
      pragma Import (C, Internal, "gtk_slice_list_model_get_size");
   begin
      return Internal (Get_Object (Self));
   end Get_Size;
   ...
   is
      procedure Internal
         (Self  : System.Address;
          Model : Glib.List_Model.Glist_Model);
      pragma Import (C, Internal, "gtk_slice_list_model_set_model");
   begin
   ...
   procedure Set_Offset
      (Self   : not null access Gtk_Slice_List_Model_Record;
       Offset : Guint)
   is
      procedure Internal (Self : System.Address; Offset : Guint);
      pragma Import (C, Internal, "gtk_slice_list_model_set_offset");
   begin
      Internal (Get_Object (Self), Offset);
   end Set_Offset;
   ...
   procedure Set_Size
      (Self : not null access Gtk_Slice_List_Model_Record;
       Size : Guint)
   is
      procedure Internal (Self : System.Address; Size : Guint);
      pragma Import (C, Internal, "gtk_slice_list_model_set_size");
   begin
