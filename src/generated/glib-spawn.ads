...
package Glib.Spawn is
   ...
   return Boolean;
   pragma Import (C, Generic_Spawn_Async, "g_spawn_async");
   ...
   return Boolean;
   pragma Import
     (C, Generic_Spawn_Async_With_Pipes, "g_spawn_async_with_pipes");
   ...
   function Generic_Spawn_Async_With_Fds
     (Working_Directory : UTF8_String := "";
      ...
      Data              : access User_Data;
      Child_Pid         : access GPid;
      Stdin_Fd          : out Glib.Gint;
      Stdout_Fd         : out Glib.Gint;
      Stderr_Fd         : out Glib.Gint;
      Error             : access Glib.Error.GError)
   return Boolean;
   pragma Import
     (C, Generic_Spawn_Async_With_Fds, "g_spawn_async_with_fds");
   ...
   function Generic_Spawn_Sync
     (Working_Directory : UTF8_String := "";
      ...
      Error             : access Glib.Error.GError)
   return Boolean;
   pragma Import (C, Generic_Spawn_Sync, "g_spawn_sync");
   ...
   return Boolean;
   pragma Import
     (C, Generic_Spawn_Command_Line_Sync, "g_spawn_command_line_sync");
