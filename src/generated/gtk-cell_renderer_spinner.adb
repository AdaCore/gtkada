...
package body Gtk.Cell_Renderer_Spinner is

   package Type_Conversion_Gtk_Cell_Renderer_Spinner is new Glib.Type_Conversion_Hooks.Hook_Registrator
   ...
   procedure Gtk_New (Self : out Gtk_Cell_Renderer_Spinner) is
   begin
      Self := new Gtk_Cell_Renderer_Spinner_Record;
      Gtk.Cell_Renderer_Spinner.Initialize (Self);
   end Gtk_New;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_cell_renderer_spinner_new");
   begin
