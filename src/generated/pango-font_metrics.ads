...
type Pango_Font_Metrics is record
   ...
   Ascent : Glib.Gint;
   Descent : Glib.Gint;
   Approximate_Char_Width : Glib.Gint;
   Approximate_Digit_Width : Glib.Gint;
   Underline_Position : Glib.Gint;
   Underline_Thickness : Glib.Gint;
   Strikethrough_Position : Glib.Gint;
   Strikethrough_Thickness : Glib.Gint;
end record;
