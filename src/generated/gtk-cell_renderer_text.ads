...
--  property allows it.
--
--  If the `GtkCellRenderer:mode` is
--  Gtk.Cell_Renderer.Cell_Renderer_Mode_Editable, the `GtkCellRendererText`
...
package Gtk.Cell_Renderer_Text is
   ...
   pragma Obsolescent (Set_Fixed_Height_From_Font);
   ...
   --  to this function. Using this function is inflexible, and should really
   ...
   --  `GtkCellRenderer`, on the other hand, sets the horizontal alignment of
   --  the whole text.
   ...
   --  greater allocation unless it is set to expand in its `GtkCellLayout` and
   --  all of the cell's siblings have received their natural width.
