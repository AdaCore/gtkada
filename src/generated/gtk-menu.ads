...
package Gtk.Menu is
   ...
   Anchor_Hints_Property : constant Glib.Properties.Property_Boxed;
   --  Type: Gdk.Anchor_Hints
   ...
   --  ![](popup-flip.png)
   --
   --  For example, GDK_ANCHOR_FLIP_Y will replace Gdk.Gravity_North_West with
...
private
   ...
   Anchor_Hints_Property : constant Glib.Properties.Property_Boxed :=
     Glib.Properties.Build ("anchor-hints");
   Active_Property : constant Glib.Properties.Property_Int :=
