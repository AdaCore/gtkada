...
package Gtk.Print_Settings is
   ...
   --  Since: gtk+ 2.10
   --  @param Duplex a Gtk.Enums.Gtk_Print_Duplex value
   ...
   --  Since: gtk+ 2.14
   --  @param Number_Up_Layout a Gtk.Enums.Gtk_Number_Up_Layout value
   ...
   --  Since: gtk+ 2.10
   --  @param Page_Ranges an array of Gtk_Page_Ranges
   ...
   --  Since: gtk+ 2.10
   --  @param Page_Set a Gtk.Enums.Gtk_Page_Set value
   ...
   --  Since: gtk+ 2.10
   --  @param Pages a Gtk.Enums.Gtk_Print_Pages value
   ...
   --  Since: gtk+ 2.10
   --  @param Quality a Gtk.Enums.Gtk_Print_Quality value
   ...
   --  Since: gtk+ 2.12
   --  @param Key_File the Gkey.File.Gkey_File to save the print settings to
