...
--  [classGtk.StackPage] objects; the button visibility in a `GtkStackSwitcher`
...
--  # CSS nodes
--
--  `GtkStackSwitcher` has a single CSS node named stackswitcher and style
...
--  # Accessibility
--
--  `GtkStackSwitcher` uses the [enumGtk.AccessibleRole.tab_list] role and
--  uses the [enumGtk.AccessibleRole.tab] role for its buttons.
--
--  # Orientable
--
...
package Gtk.Stack_Switcher is
   ...
   type Gtk_Stack_Switcher_Record is new Gtk_Widget_Record with null record;
   ...
   --  Retrieves the stack.
   --  @return the stack. Has transfer-ownership='none'.
   ...
   function Get_Accessible_Id
      (Self : not null access Gtk_Stack_Switcher_Record) return UTF8_String;
   ...
   package Implements_Gtk_Accessible is new Glib.Types.Implements
     (Gtk.Accessible.Gtk_Accessible, Gtk_Stack_Switcher_Record, Gtk_Stack_Switcher);
   function "+"
   ...
   package Implements_Gtk_Constraint_Target is new Glib.Types.Implements
     (Gtk.Constraint_Target.Gtk_Constraint_Target, Gtk_Stack_Switcher_Record, Gtk_Stack_Switcher);
   function "+"
     (Widget : access Gtk_Stack_Switcher_Record'Class)
