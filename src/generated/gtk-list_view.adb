...
package body Gtk.List_View is

   package Type_Conversion_Gtk_List_View is new Glib.Type_Conversion_Hooks.Hook_Registrator
     (Get_Type'Access, Gtk_List_View_Record);
   pragma Unreferenced (Type_Conversion_Gtk_List_View);
   ...
   is
      Self : constant Gtk_List_View := new Gtk_List_View_Record;
   begin
      Gtk.List_View.Initialize (Self, Model, Factory);
      return Self;
   end Gtk_List_View_New;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_list_view_new");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_list_view_get_enable_rubberband");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_list_view_get_factory");
   ...
   is
      function Internal (Self : System.Address) return System.Address;
      pragma Import (C, Internal, "gtk_list_view_get_header_factory");
      Stub_Gtk_List_Item_Factory : Gtk.List_Item_Factory.Gtk_List_Item_Factory_Record;
   begin
      return Gtk.List_Item_Factory.Gtk_List_Item_Factory (Get_User_Data (Internal (Get_Object (Self)), Stub_Gtk_List_Item_Factory));
   ...
   is
      function Internal
         (Self : System.Address)
          return Gtk.Selection_Model.Gtk_Selection_Model;
      pragma Import (C, Internal, "gtk_list_view_get_model");
   begin
   ...
   is
      function Internal (Self : System.Address) return Glib.Gboolean;
      pragma Import (C, Internal, "gtk_list_view_get_show_separators");
   begin
      return Internal (Get_Object (Self)) /= 0;
   end Get_Show_Separators;
   ...
   is
      function Internal (Self : System.Address) return Glib.Gboolean;
      pragma Import (C, Internal, "gtk_list_view_get_single_click_activate");
   begin
      return Internal (Get_Object (Self)) /= 0;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_list_view_get_tab_behavior");
   begin
      return Internal (Get_Object (Self));
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_list_view_scroll_to");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_list_view_set_enable_rubberband");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_list_view_set_factory");
   begin
   ...
   is
      procedure Internal (Self : System.Address; Factory : System.Address);
      pragma Import (C, Internal, "gtk_list_view_set_header_factory");
   begin
      Internal (Get_Object (Self), Get_Object_Or_Null (GObject (Factory)));
   ...
   is
      procedure Internal
         (Self  : System.Address;
          Model : Gtk.Selection_Model.Gtk_Selection_Model);
      pragma Import (C, Internal, "gtk_list_view_set_model");
   begin
   ...
   is
      procedure Internal
         (Self            : System.Address;
          Show_Separators : Glib.Gboolean);
      pragma Import (C, Internal, "gtk_list_view_set_show_separators");
   begin
      Internal (Get_Object (Self), Boolean'Pos (Show_Separators));
   end Set_Show_Separators;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_list_view_set_single_click_activate");
   begin
   ...
   is
      procedure Internal
         (Self         : System.Address;
          Tab_Behavior : Gtk.Enums.Gtk_List_Tab_Behavior);
      pragma Import (C, Internal, "gtk_list_view_set_tab_behavior");
   begin
   ...
   function Cb_To_Address is new Ada.Unchecked_Conversion
     (Cb_Gtk_List_View_Guint_Void, System.Address);
   function Address_To_Cb is new Ada.Unchecked_Conversion
     (System.Address, Cb_Gtk_List_View_Guint_Void);
   ...
   procedure Connect
      (Object  : access Gtk_List_View_Record'Class;
       C_Name  : Glib.Signal_Name;
       Handler : Cb_Gtk_List_View_Guint_Void;
       After   : Boolean);
   ...
   procedure Marsh_Gtk_List_View_Guint_Void
      (Closure         : GClosure;
       Return_Value    : Glib.Values.GValue;
       N_Params        : Glib.Guint;
       Params          : Glib.Values.C_GValues;
       Invocation_Hint : System.Address;
       User_Data       : System.Address);
   pragma Convention (C, Marsh_Gtk_List_View_Guint_Void);
   ...
   begin
      Unchecked_Do_Signal_Connect
        (Object      => Object,
         C_Name      => C_Name,
         Marshaller  => Marsh_Gtk_List_View_Guint_Void'Access,
   ...
   ------------------------------------
   -- Marsh_Gtk_List_View_Guint_Void --
   ------------------------------------
   ...
   is
      pragma Unreferenced (Return_Value, N_Params, Invocation_Hint, User_Data);
      H   : constant Cb_Gtk_List_View_Guint_Void := Address_To_Cb (Get_Callback (Closure));
      Obj : constant Gtk_List_View := Gtk_List_View (Unchecked_To_Object (Params, 0));
   begin
      H (Obj, Unchecked_To_Guint (Params, 1));
   exception
      when E : others => Process_Exception (E);
   end Marsh_Gtk_List_View_Guint_Void;
