...
package body Gdk.Memory_Texture is
   ...
   package Type_Conversion_Gdk_Memory_Texture is new Glib.Type_Conversion_Hooks.Hook_Registrator
     (Get_Type'Access, Gdk_Memory_Texture_Record);
   pragma Unreferenced (Type_Conversion_Gdk_Memory_Texture);
   ...
   is
      Self : constant Gdk_Memory_Texture := new Gdk_Memory_Texture_Record;
   begin
      Gdk.Memory_Texture.Initialize (Self, Width, Height, Format, Bytes, Stride);
      return Self;
   end Gdk_Memory_Texture_New;
   ...
   is
   begin
      Self := new Gdk_Memory_Texture_Record;
      Gdk.Memory_Texture.Initialize (Self, Width, Height, Format, Bytes, Stride);
   end Gdk_New;
   ...
   is
      function Internal
         (Width  : Glib.Gint;
          ...
          Stride : Gsize) return System.Address;
      pragma Import (C, Internal, "gdk_memory_texture_new");
   begin
      if not Self.Is_Created then
         Set_Object (Self, Internal (Width, Height, Format, Get_Object (Bytes), Stride));
      end if;
   end Initialize;
