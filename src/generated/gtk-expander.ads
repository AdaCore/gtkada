...
package Gtk.Expander is
   ...
   function Get_Expanded (Self : access Gtk_Expander_Record) return Boolean;
   ...
   function Get_Label (Self : access Gtk_Expander_Record) return UTF8_String;
   procedure Set_Label
      (Self  : access Gtk_Expander_Record;
       Label : UTF8_String);
   ...
   function Get_Spacing (Self : access Gtk_Expander_Record) return Gint;
   procedure Set_Spacing (Self : access Gtk_Expander_Record; Spacing : Gint);
   ...
   -- 
   --  "activate"
   --  function Handler (Self : access Gtk_Expander_Record'Class) return --
   --  none;
