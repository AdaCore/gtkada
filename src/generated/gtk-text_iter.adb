...
package body Gtk.Text_Iter is
   ...
   function C_Gtk_Text_Iter_Backward_Find_Char
      (Iter      : in out Gtk_Text_Iter;
       Pred      : System.Address;
       User_Data : System.Address;
       Limit     : System.Address) return Glib.Gboolean;
   pragma Import (C, C_Gtk_Text_Iter_Backward_Find_Char, "gtk_text_iter_backward_find_char");
   ...
   function C_Gtk_Text_Iter_Forward_Find_Char
      (Iter      : in out Gtk_Text_Iter;
       Pred      : System.Address;
       User_Data : System.Address;
       Limit     : System.Address) return Glib.Gboolean;
   pragma Import (C, C_Gtk_Text_Iter_Forward_Find_Char, "gtk_text_iter_forward_find_char");
   ...
   function To_Gtk_Text_Char_Predicate is new Ada.Unchecked_Conversion
     (System.Address, Gtk_Text_Char_Predicate);

   function To_Address is new Ada.Unchecked_Conversion
     (Gtk_Text_Char_Predicate, System.Address);

   function Internal_Gtk_Text_Char_Predicate
      (Ch        : Gunichar;
       User_Data : System.Address) return Glib.Gboolean;
   pragma Convention (C, Internal_Gtk_Text_Char_Predicate);
   --  @param Ch a Unicode code point
   --  @param User_Data data passed to the callback

   --------------------------------------
   -- Internal_Gtk_Text_Char_Predicate --
   --------------------------------------
   ...
   function Internal_Gtk_Text_Char_Predicate
      (Ch        : Gunichar;
       User_Data : System.Address) return Glib.Gboolean
   is
      Func : constant Gtk_Text_Char_Predicate := To_Gtk_Text_Char_Predicate (User_Data);
   begin
      return Boolean'Pos (Func (Ch));
   end Internal_Gtk_Text_Char_Predicate;
   ...
   is
      Tmp_Iter   : aliased Gtk_Text_Iter := Iter;
      Tmp_Return : Glib.Gboolean;
   begin
      if Pred = null then
         Tmp_Return := C_Gtk_Text_Iter_Backward_Find_Char (Tmp_Iter, System.Null_Address, System.Null_Address, Iter_Or_Null (Limit'Address));
         Iter := Tmp_Iter;
         return Tmp_Return /= 0;
      else
         Tmp_Return := C_Gtk_Text_Iter_Backward_Find_Char (Tmp_Iter, Internal_Gtk_Text_Char_Predicate'Address, To_Address (Pred), Iter_Or_Null (Limit'Address));
         Iter := Tmp_Iter;
         return Tmp_Return /= 0;
      end if;
   ...
   begin
      if Pred = null then
         Tmp_Return := C_Gtk_Text_Iter_Forward_Find_Char (Tmp_Iter, System.Null_Address, System.Null_Address, Iter_Or_Null (Limit'Address));
         Iter := Tmp_Iter;
         return Tmp_Return /= 0;
      else
         Tmp_Return := C_Gtk_Text_Iter_Forward_Find_Char (Tmp_Iter, Internal_Gtk_Text_Char_Predicate'Address, To_Address (Pred), Iter_Or_Null (Limit'Address));
         Iter := Tmp_Iter;
         return Tmp_Return /= 0;
      end if;
   end Forward_Find_Char;

   package body Forward_Find_Char_User_Data is
      ...
      begin
         return Boolean'Pos (To_Gtk_Text_Char_Predicate (D.Func) (Ch, D.Data.all));
      end Internal_Cb;
