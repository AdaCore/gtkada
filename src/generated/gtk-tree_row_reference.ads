...
package Gtk.Tree_Row_Reference is
   ...
   procedure Gtk_New
      (Self  : out Gtk_Tree_Row_Reference;
   ...
   --  `GtkTreeView` already use this mechanism internally, using them as the
   --  proxy object will produce unpredictable results. Further more, passing
   --  the same object as Model and Proxy doesn't work for reasons of internal
   --  implementation.
   ...
   function Copy
      (Self : Gtk_Tree_Row_Reference) return Gtk_Tree_Row_Reference;
   ...
   function Get_Model
      (Self : Gtk_Tree_Row_Reference) return Gtk.Tree_Model.Gtk_Tree_Model;
   ...
   function Get_Path
      (Self : Gtk_Tree_Row_Reference) return Gtk.Tree_Model.Gtk_Tree_Path;
