...
package body Gtk.Check_Button is
   ...
   function Gtk_Check_Button_New return Gtk_Check_Button is
      Self : constant Gtk_Check_Button := new Gtk_Check_Button_Record;
   begin
      Gtk.Check_Button.Initialize (Self);
      return Self;
   end Gtk_Check_Button_New;
   ...
   is
      Self : constant Gtk_Check_Button := new Gtk_Check_Button_Record;
   begin
      Gtk.Check_Button.Initialize_With_Label (Self, Label);
      return Self;
   ...
   is
      Self : constant Gtk_Check_Button := new Gtk_Check_Button_Record;
   begin
      Gtk.Check_Button.Initialize_With_Mnemonic (Self, Label);
      return Self;
   ...
   procedure Gtk_New (Self : out Gtk_Check_Button) is
   begin
      Self := new Gtk_Check_Button_Record;
      Gtk.Check_Button.Initialize (Self);
   end Gtk_New;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_check_button_get_active");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_check_button_get_child");
   ...
   is
      function Internal (Self : System.Address) return Glib.Gboolean;
      pragma Import (C, Internal, "gtk_check_button_get_inconsistent");
   begin
      return Internal (Get_Object (Self)) /= 0;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_check_button_get_label");
   begin
   ...
   is
      function Internal (Self : System.Address) return Glib.Gboolean;
      pragma Import (C, Internal, "gtk_check_button_get_use_underline");
   begin
      return Internal (Get_Object (Self)) /= 0;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_check_button_set_active");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_check_button_set_child");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_check_button_set_group");
   begin
   ...
   is
      procedure Internal
         (Self         : System.Address;
          Inconsistent : Glib.Gboolean);
      pragma Import (C, Internal, "gtk_check_button_set_inconsistent");
   begin
      Internal (Get_Object (Self), Boolean'Pos (Inconsistent));
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_check_button_set_label");
      Tmp_Label : Gtkada.Types.Chars_Ptr;
   begin
      if Label = "" then
         Tmp_Label := Gtkada.Types.Null_Ptr;
   ...
   is
      procedure Internal (Self : System.Address; Setting : Glib.Gboolean);
      pragma Import (C, Internal, "gtk_check_button_set_use_underline");
   begin
      Internal (Get_Object (Self), Boolean'Pos (Setting));
   ...
   function Cb_To_Address is new Ada.Unchecked_Conversion
     (Cb_Gtk_Check_Button_Void, System.Address);
   function Address_To_Cb is new Ada.Unchecked_Conversion
     (System.Address, Cb_Gtk_Check_Button_Void);
   ...
   procedure Marsh_Gtk_Check_Button_Void
      (Closure         : GClosure;
       Return_Value    : Glib.Values.GValue;
       N_Params        : Glib.Guint;
       Params          : Glib.Values.C_GValues;
       Invocation_Hint : System.Address;
       User_Data       : System.Address);
   pragma Convention (C, Marsh_Gtk_Check_Button_Void);
   ...
   begin
      Unchecked_Do_Signal_Connect
        (Object      => Object,
         C_Name      => C_Name,
         Marshaller  => Marsh_Gtk_Check_Button_Void'Access,
   ...
   is
      ...
      H   : constant Cb_Gtk_Check_Button_Void := Address_To_Cb (Get_Callback (Closure));
