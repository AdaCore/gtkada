...
package body Gdk.RGBA is
   ...
   function Is_Clear (Self : Gdk_RGBA) return Boolean is
      function Internal (Self : Gdk_RGBA) return Glib.Gboolean;
      pragma Import (C, Internal, "gdk_rgba_is_clear");
   begin
   ...
   function Is_Opaque (Self : Gdk_RGBA) return Boolean is
      function Internal (Self : Gdk_RGBA) return Glib.Gboolean;
      pragma Import (C, Internal, "gdk_rgba_is_opaque");
   begin
      return Internal (Self) /= 0;
   end Is_Opaque;
