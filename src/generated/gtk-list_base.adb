...
package body Gtk.List_Base is

   package Type_Conversion_Gtk_List_Base is new Glib.Type_Conversion_Hooks.Hook_Registrator
     (Get_Type'Access, Gtk_List_Base_Record);
   pragma Unreferenced (Type_Conversion_Gtk_List_Base);
