...
--
--  Apart from regular actions, there are <link
--  linkend="GtkToggleAction">toggle actions</link>, which can be toggled
--  between two states and <link linkend="GtkRadioAction">radio actions</link>,
--  of which only one in a group can be in the "active" state. Other actions
--  can be implemented as Gtk.Action.Gtk_Action subclasses.
--
