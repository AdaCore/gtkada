...
--  functions:
--
--  |[<!-- language="C" --> void im_module_init(Gtype.Module.Gtype_Module
--  *module); ]| This function should register the GType of the
...
--
--  |[<!-- language="C" --> void im_module_list(const Gtk_IMContext_Info
...
--
--  |[<!-- language="C" --> Gtk.IM_Context.Gtk_IM_Context *
--  im_module_create(const Gchar *context_id); ]| This function should return a
--  pointer to a newly created instance of the Gtk.IM_Context.Gtk_IM_Context
--  subclass identified by Context_Id. The context ID is the same as specified
--  in the Gtk_IMContext_Info array returned by im_module_list.
--
