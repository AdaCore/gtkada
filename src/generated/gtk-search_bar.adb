...
package body Gtk.Search_Bar is
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_search_bar_get_child");
   ...
   is
      function Internal (Self : System.Address) return System.Address;
      pragma Import (C, Internal, "gtk_search_bar_get_key_capture_widget");
      Stub_Gtk_Widget : Gtk.Widget.Gtk_Widget_Record;
   begin
      return Gtk.Widget.Gtk_Widget (Get_User_Data (Internal (Get_Object (Self)), Stub_Gtk_Widget));
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_search_bar_set_child");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_search_bar_set_key_capture_widget");
   begin
