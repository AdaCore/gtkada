...
package body Gtk.Tree_Selection is
   ...
   begin
      Selected := Internal (Get_Object (Self), M'Access);
      Model := M;
   ...
   pragma Obsolescent (C_Gtk_Tree_Selection_Selected_Foreach);
   ...
   pragma Obsolescent (C_Gtk_Tree_Selection_Set_Select_Function);
   ...
   procedure Internal_Gtk_Tree_Selection_Foreach_Func
      (Model : Gtk.Tree_Model.Gtk_Tree_Model;
       ...
       Data  : System.Address);
   pragma Obsolescent (Internal_Gtk_Tree_Selection_Foreach_Func);
   ...
   pragma Obsolescent (Internal_Gtk_Tree_Selection_Func);
   ...
   begin
      if Internal (Get_Object (Self), M'Access, It'Access) = 0 then
         Iter  := Null_Iter;
      else
         Iter  := It;
      end if;
   ...
   procedure Select_All (Self : not null access Gtk_Tree_Selection_Record) is
      procedure Internal (Self : System.Address);
   ...
   begin
      Internal (Get_Object (Self), Get_Object (Start_Path), Get_Object (End_Path));
   end Select_Range;
   ...
   begin
      if Func = null then
         C_Gtk_Tree_Selection_Selected_Foreach (Get_Object (Self), System.Null_Address, System.Null_Address);
      else
         C_Gtk_Tree_Selection_Selected_Foreach (Get_Object (Self), Internal_Gtk_Tree_Selection_Foreach_Func'Address, To_Address (Func));
      end if;
   ...
   package body Selected_Foreach_User_Data is
      ...
      begin
         if Func = null then
            ...
            C_Gtk_Tree_Selection_Selected_Foreach (Get_Object (Self), Internal_Cb'Address, D);
            Users.Free_Data (D);
         end if;
      end Selected_Foreach;
   ...
   begin
      if Func = null then
         C_Gtk_Tree_Selection_Set_Select_Function (Get_Object (Self), System.Null_Address, System.Null_Address, System.Null_Address);
      else
         C_Gtk_Tree_Selection_Set_Select_Function (Get_Object (Self), Internal_Gtk_Tree_Selection_Func'Address, To_Address (Func), System.Null_Address);
      end if;
   ...
   package body Set_Select_Function_User_Data is
      ...
      begin
         if Func = null then
            C_Gtk_Tree_Selection_Set_Select_Function (Get_Object (Self), System.Null_Address, System.Null_Address, Users.Free_Data'Address);
         else
            D := Users.Build (To_Address (Func), Data);
            C_Gtk_Tree_Selection_Set_Select_Function (Get_Object (Self), Internal_Cb'Address, D, Users.Free_Data'Address);
         end if;
      end Set_Select_Function;
   ...
   procedure Unselect_All (Self : not null access Gtk_Tree_Selection_Record) is
      procedure Internal (Self : System.Address);
