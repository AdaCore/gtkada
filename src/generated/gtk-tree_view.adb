...
package body Gtk.Tree_View is
   ...
   pragma Obsolescent (C_Gtk_Tree_View_Set_Column_Drag_Function);
   ...
   pragma Obsolescent (C_Gtk_Tree_View_Set_Search_Equal_Func);
   ...
   procedure Internal_Gtk_Tree_Cell_Data_Func
      (Tree_Column : System.Address;
       ...
       Data        : System.Address);
   pragma Obsolescent (Internal_Gtk_Tree_Cell_Data_Func);
   ...
   pragma Obsolescent (Internal_Gtk_Tree_View_Column_Drop_Func);
   ...
   procedure Internal_Gtk_Tree_View_Mapping_Func
      (Tree_View : System.Address;
       Path      : System.Address;
       User_Data : System.Address);
   pragma Obsolescent (Internal_Gtk_Tree_View_Mapping_Func);
   ...
   function Internal_Gtk_Tree_View_Row_Separator_Func
      (Model : Gtk.Tree_Model.Gtk_Tree_Model;
       Iter  : access Gtk.Tree_Model.Gtk_Tree_Iter;
       Data  : System.Address) return Glib.Gboolean;
   pragma Obsolescent (Internal_Gtk_Tree_View_Row_Separator_Func);
   ...
   pragma Obsolescent (Internal_Gtk_Tree_View_Search_Equal_Func);
   ...
   is
      function Internal
         (Self   : System.Address;
          Drag_X : Glib.Gint;
          Drag_Y : Glib.Gint;
          Path   : access System.Address;
          Pos    : access Gtk_Tree_View_Drop_Position) return Glib.Gboolean;
      pragma Import (C, Internal, "gtk_tree_view_get_dest_row_at_pos");
      Tmp_Path   : aliased System.Address := System.Null_Address;
      Acc_Path   : constant access System.Address := (if Path /= null then Tmp_Path'Access else null);
   ...
   package body Insert_Column_With_Data_Func_User_Data is
      ...
      --  example, a function might get an* integer from the Tree_Model, and
      --  render it to the "text" attribute of "cell" by converting it to its
      --  written equivalent.
      --  See also: gtk_tree_view_column_set_cell_data_func
      --  Deprecated since 4.20, 1
      --  @param Tree_Column A `GtkTreeViewColumn`
      --  @param Cell The `GtkCellRenderer` that is being rendered by
      --  Tree_Column
      --  @param Tree_Model The `GtkTreeModel` being rendered
      --  @param Iter A `GtkTreeIter` of the current row rendered
      --  @param Data user data
   ...
   is
      function Internal
         (Self   : System.Address;
          ...
          Cell_Y : access Glib.Gint) return Glib.Gboolean;
      pragma Import (C, Internal, "gtk_tree_view_is_blank_at_pos");
      Tmp_Path                  : aliased System.Address := System.Null_Address;
      Acc_Path                  : constant access System.Address := (if Path /= null then Tmp_Path'Access else null);
      Tmp_Column                : aliased System.Address := System.Null_Address;
      Acc_Column                : constant access System.Address := (if Column /= null then Tmp_Column'Access else null);
      Stub_Gtk_Tree_View_Column : Gtk.Tree_View_Column.Gtk_Tree_View_Column_Record;
      Tmp_Return                : Glib.Gboolean;
   begin
      Tmp_Return := Internal (Get_Object (Self), X, Y, Acc_Path, Acc_Column, Cell_X, Cell_Y);
      if Column /= null then
         Column.all := Gtk.Tree_View_Column.Gtk_Tree_View_Column (Get_User_Data (Tmp_Column, Stub_Gtk_Tree_View_Column));
      end if;
      if Path /= null then
         Path.all := From_Object (Tmp_Path);
      end if;
   ...
   function Cb_To_Address is new Ada.Unchecked_Conversion
     (Cb_Gtk_Tree_View_Gtk_Movement_Step_Gint_Boolean_Boolean_Boolean, System.Address);
   function Address_To_Cb is new Ada.Unchecked_Conversion
     (System.Address, Cb_Gtk_Tree_View_Gtk_Movement_Step_Gint_Boolean_Boolean_Boolean);

   function Cb_To_Address is new Ada.Unchecked_Conversion
     (Cb_GObject_Gtk_Movement_Step_Gint_Boolean_Boolean_Boolean, System.Address);
   function Address_To_Cb is new Ada.Unchecked_Conversion
   ...
   procedure Connect
      (Object  : access Gtk_Tree_View_Record'Class;
       C_Name  : Glib.Signal_Name;
       Handler : Cb_Gtk_Tree_View_Gtk_Movement_Step_Gint_Boolean_Boolean_Boolean;
       After   : Boolean);
   ...
   procedure Connect_Slot
      (Object  : access Gtk_Tree_View_Record'Class;
       C_Name  : Glib.Signal_Name;
       Handler : Cb_GObject_Gtk_Movement_Step_Gint_Boolean_Boolean_Boolean;
       After   : Boolean;
       Slot    : access Glib.Object.GObject_Record'Class := null);
   ...
   procedure Marsh_GObject_Gtk_Movement_Step_Gint_Boolean_Boolean_Boolean
      (Closure         : GClosure;
       Return_Value    : Glib.Values.GValue;
       N_Params        : Glib.Guint;
       Params          : Glib.Values.C_GValues;
       Invocation_Hint : System.Address;
       User_Data       : System.Address);
   pragma Convention (C, Marsh_GObject_Gtk_Movement_Step_Gint_Boolean_Boolean_Boolean);
   ...
   procedure Marsh_Gtk_Tree_View_Gtk_Movement_Step_Gint_Boolean_Boolean_Boolean
      (Closure         : GClosure;
       Return_Value    : Glib.Values.GValue;
       N_Params        : Glib.Guint;
       Params          : Glib.Values.C_GValues;
       Invocation_Hint : System.Address;
       User_Data       : System.Address);
   pragma Convention (C, Marsh_Gtk_Tree_View_Gtk_Movement_Step_Gint_Boolean_Boolean_Boolean);
   ...
   begin
      Unchecked_Do_Signal_Connect
        (Object      => Object,
         C_Name      => C_Name,
         Marshaller  => Marsh_Gtk_Tree_View_Gtk_Movement_Step_Gint_Boolean_Boolean_Boolean'Access,
         Handler     => Cb_To_Address (Handler),--  Set in the closure
         After       => After);
   end Connect;
   ...
   begin
      Unchecked_Do_Signal_Connect
        (Object      => Object,
         C_Name      => C_Name,
         Marshaller  => Marsh_GObject_Gtk_Movement_Step_Gint_Boolean_Boolean_Boolean'Access,
         Handler     => Cb_To_Address (Handler),--  Set in the closure
         Slot_Object => Slot,
         After       => After);
   end Connect_Slot;
   ...
   ------------------------------------------------------------------
   -- Marsh_GObject_Gtk_Movement_Step_Gint_Boolean_Boolean_Boolean --
   ------------------------------------------------------------------
   ...
   is
      pragma Unreferenced (N_Params, Invocation_Hint, User_Data);
      H   : constant Cb_GObject_Gtk_Movement_Step_Gint_Boolean_Boolean_Boolean := Address_To_Cb (Get_Callback (Closure));
      Obj : constant Glib.Object.GObject := Glib.Object.Convert (Get_Data (Closure));
   ...
   ------------------------------------------------------------------------
   -- Marsh_Gtk_Tree_View_Gtk_Movement_Step_Gint_Boolean_Boolean_Boolean --
   ------------------------------------------------------------------------
   ...
   is
      pragma Unreferenced (N_Params, Invocation_Hint, User_Data);
      H   : constant Cb_Gtk_Tree_View_Gtk_Movement_Step_Gint_Boolean_Boolean_Boolean := Address_To_Cb (Get_Callback (Closure));
      Obj : constant Gtk_Tree_View := Gtk_Tree_View (Unchecked_To_Object (Params, 0));
      V   : aliased Boolean := H (Obj, Unchecked_To_Gtk_Movement_Step (Params, 1), Unchecked_To_Gint (Params, 2), Unchecked_To_Boolean (Params, 3), Unchecked_To_Boolean (Params, 4));
   begin
      Set_Value (Return_Value, V'Address);
