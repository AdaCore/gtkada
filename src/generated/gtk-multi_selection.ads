...
package Gtk.Multi_Selection is

   type Gtk_Multi_Selection_Record is new GObject_Record with null record;
   type Gtk_Multi_Selection is access all Gtk_Multi_Selection_Record'Class;
   ...
   pragma Import (C, Get_Type, "gtk_multi_selection_get_type");
   ...
   package Implements_Glist_Model is new Glib.Types.Implements
     (Glib.List_Model.Glist_Model, Gtk_Multi_Selection_Record, Gtk_Multi_Selection);
   function "+"
     (Widget : access Gtk_Multi_Selection_Record'Class)
   return Glib.List_Model.Glist_Model
   renames Implements_Glist_Model.To_Interface;
   function "-"
     (Interf : Glib.List_Model.Glist_Model)
   return Gtk_Multi_Selection
   renames Implements_Glist_Model.To_Object;

   package Implements_Gtk_Section_Model is new Glib.Types.Implements
     (Gtk.Section_Model.Gtk_Section_Model, Gtk_Multi_Selection_Record, Gtk_Multi_Selection);
   function "+"
     (Widget : access Gtk_Multi_Selection_Record'Class)
   ...
   package Implements_Gtk_Selection_Model is new Glib.Types.Implements
     (Gtk.Selection_Model.Gtk_Selection_Model, Gtk_Multi_Selection_Record, Gtk_Multi_Selection);
   function "+"
     (Widget : access Gtk_Multi_Selection_Record'Class)
