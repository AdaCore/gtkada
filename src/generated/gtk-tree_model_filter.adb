...
package body Gtk.Tree_Model_Filter is
   ...
   pragma Obsolescent (C_Gtk_Tree_Model_Filter_Set_Modify_Func);
   ...
   pragma Obsolescent (C_Gtk_Tree_Model_Filter_Set_Visible_Func);
   ...
   procedure Internal_Gtk_Tree_Model_Filter_Modify_Func
      (Model  : Gtk.Tree_Model.Gtk_Tree_Model;
       ...
       Column : Glib.Gint;
       Data   : System.Address);
   pragma Obsolescent (Internal_Gtk_Tree_Model_Filter_Modify_Func);
   ...
   pragma Obsolescent (Internal_Gtk_Tree_Model_Filter_Visible_Func);
