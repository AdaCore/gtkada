...
package body Gtk.Overlay is
   ...
   function Cb_To_Address is new Ada.Unchecked_Conversion
     (Cb_Gtk_Overlay_Gtk_Widget_Cairo_Rectangle_Boolean, System.Address);
   function Address_To_Cb is new Ada.Unchecked_Conversion
     (System.Address, Cb_Gtk_Overlay_Gtk_Widget_Cairo_Rectangle_Boolean);

   function Cb_To_Address is new Ada.Unchecked_Conversion
     (Cb_GObject_Gtk_Widget_Cairo_Rectangle_Boolean, System.Address);
   function Address_To_Cb is new Ada.Unchecked_Conversion
     (System.Address, Cb_GObject_Gtk_Widget_Cairo_Rectangle_Boolean);

   procedure Connect
      (Object  : access Gtk_Overlay_Record'Class;
       C_Name  : Glib.Signal_Name;
       Handler : Cb_Gtk_Overlay_Gtk_Widget_Cairo_Rectangle_Boolean;
       After   : Boolean);

   procedure Connect_Slot
      (Object  : access Gtk_Overlay_Record'Class;
       C_Name  : Glib.Signal_Name;
       Handler : Cb_GObject_Gtk_Widget_Cairo_Rectangle_Boolean;
       After   : Boolean;
       Slot    : access Glib.Object.GObject_Record'Class := null);

   procedure Marsh_GObject_Gtk_Widget_Cairo_Rectangle_Boolean
      (Closure         : GClosure;
   ...
   pragma Convention (C, Marsh_GObject_Gtk_Widget_Cairo_Rectangle_Boolean);

   procedure Marsh_Gtk_Overlay_Gtk_Widget_Cairo_Rectangle_Boolean
      (Closure         : GClosure;
       Return_Value    : Glib.Values.GValue;
       N_Params        : Glib.Guint;
       Params          : Glib.Values.C_GValues;
       Invocation_Hint : System.Address;
       User_Data       : System.Address);
   pragma Convention (C, Marsh_Gtk_Overlay_Gtk_Widget_Cairo_Rectangle_Boolean);
   ...
   begin
      Unchecked_Do_Signal_Connect
        (Object      => Object,
         C_Name      => C_Name,
         Marshaller  => Marsh_Gtk_Overlay_Gtk_Widget_Cairo_Rectangle_Boolean'Access,
   ...
   ------------------------------------------------------
   -- Marsh_GObject_Gtk_Widget_Cairo_Rectangle_Boolean --
   ------------------------------------------------------
   ...
   end Marsh_GObject_Gtk_Widget_Cairo_Rectangle_Boolean;

   ----------------------------------------------------------
   -- Marsh_Gtk_Overlay_Gtk_Widget_Cairo_Rectangle_Boolean --
   ----------------------------------------------------------
   ...
   begin
      Set_Value (Return_Value, V'Address);
      exception when E : others => Process_Exception (E);
   end Marsh_Gtk_Overlay_Gtk_Widget_Cairo_Rectangle_Boolean;
