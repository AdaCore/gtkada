...
package body Gtk.Paper_Size is
   ...
   procedure Gtk_New (Self : out Gtk_Paper_Size; Name : UTF8_String := "") is
      function Internal
   ...
   begin
      Self.Set_Object (Internal (Get_Object (Variant)));
   ...
   begin
      ...
      Tmp_Return := Internal (Key_File, Tmp_Group_Name, Acc_Error'Access);
      Error := Acc_Error;
      if Error = null then
         Self.Set_Object (Tmp_Return);
      end if;
   ...
   function Copy (Self : Gtk_Paper_Size) return Gtk_Paper_Size is
   ...
   procedure Free (Self : Gtk_Paper_Size) is
   ...
   function Get_Display_Name (Self : Gtk_Paper_Size) return UTF8_String is
      function Internal
   ...
   function Get_Name (Self : Gtk_Paper_Size) return UTF8_String is
      function Internal
         (Self : System.Address) return Gtkada.Types.Chars_Ptr;
   ...
   function Get_Ppd_Name (Self : Gtk_Paper_Size) return UTF8_String is
      function Internal
         (Self : System.Address) return Gtkada.Types.Chars_Ptr;
   ...
   function Is_Custom (Self : Gtk_Paper_Size) return Boolean is
   ...
   begin
      return Internal (Get_Object (Self), Get_Object (Size2)) /= 0;
   end Is_Equal;
   ...
   function Is_Ipp (Self : Gtk_Paper_Size) return Boolean is
      function Internal (Self : System.Address) return Glib.Gboolean;
   ...
   begin
      Internal (Get_Object (Self), Width, Height, Unit);
   end Set_Size;
   ...
   function To_Gvariant (Self : Gtk_Paper_Size) return Glib.Variant.Gvariant is
      function Internal (Self : System.Address) return System.Address;
   ...
   is
      ...
      Tmp_Return : Paper_Size_List.Glist;
   begin
      Gtk.Paper_Size.Paper_Size_List.Set_Object (Tmp_Return, Internal (Boolean'Pos (Include_Custom)));
      return Tmp_Return;
   end Get_Paper_Sizes;
