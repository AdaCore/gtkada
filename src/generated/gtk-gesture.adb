...
package body Gtk.Gesture is
   ...
   function Convert (R : System.Address) return Gtk.Gesture.Gtk_Gesture is
      Stub : Gtk.Gesture.Gtk_Gesture_Record;
   begin
   ...
   is
      function Internal
         (Self     : System.Address;
          Sequence : Gdk.Event.Gdk_Event_Sequence) return System.Address;
      pragma Import (C, Internal, "gtk_gesture_get_last_event");
   begin
      return From_Object (Internal (Get_Object (Self), Sequence));
   end Get_Last_Event;
   ...
   is
      function Internal
         (Self : System.Address) return Gdk.Event.Gdk_Event_Sequence;
   ...
   begin
      return Internal (Get_Object (Self), Sequence, X, Y) /= 0;
   end Get_Point;
