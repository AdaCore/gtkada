...
package body Gtk.Toggle_Tool_Button is
   ...
   function Cb_To_Address is new Ada.Unchecked_Conversion
     (Cb_Gtk_Toggle_Tool_Button_Void, System.Address);
   function Address_To_Cb is new Ada.Unchecked_Conversion
     (System.Address, Cb_Gtk_Toggle_Tool_Button_Void);
   ...
   procedure Connect
      (Object  : access Gtk_Toggle_Tool_Button_Record'Class;
       C_Name  : Glib.Signal_Name;
       Handler : Cb_Gtk_Toggle_Tool_Button_Void;
       After   : Boolean);
   ...
   procedure Marsh_Gtk_Toggle_Tool_Button_Void
      (Closure         : GClosure;
       Return_Value    : Glib.Values.GValue;
       N_Params        : Glib.Guint;
       Params          : Glib.Values.C_GValues;
       Invocation_Hint : System.Address;
       User_Data       : System.Address);
   pragma Convention (C, Marsh_Gtk_Toggle_Tool_Button_Void);
   ...
   begin
      Unchecked_Do_Signal_Connect
        (Object      => Object,
         C_Name      => C_Name,
         Marshaller  => Marsh_Gtk_Toggle_Tool_Button_Void'Access,
   ...
   ---------------------------------------
   -- Marsh_Gtk_Toggle_Tool_Button_Void --
   ---------------------------------------
   ...
   is
      ...
      H   : constant Cb_Gtk_Toggle_Tool_Button_Void := Address_To_Cb (Get_Callback (Closure));
      Obj : constant access Gtk_Toggle_Tool_Button_Record'Class := Gtk_Toggle_Tool_Button (Unchecked_To_Object (Params, 0));
   begin
      H (Obj);
      exception when E : others => Process_Exception (E);
   end Marsh_Gtk_Toggle_Tool_Button_Void;
