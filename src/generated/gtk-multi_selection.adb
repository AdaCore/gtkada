...
package body Gtk.Multi_Selection is

   package Type_Conversion_Gtk_Multi_Selection is new Glib.Type_Conversion_Hooks.Hook_Registrator
     (Get_Type'Access, Gtk_Multi_Selection_Record);
   pragma Unreferenced (Type_Conversion_Gtk_Multi_Selection);

   -----------------------------
   -- Gtk_Multi_Selection_New --
   -----------------------------

   function Gtk_Multi_Selection_New
      (Model : Glib.List_Model.Glist_Model) return Gtk_Multi_Selection
   is
      Self : constant Gtk_Multi_Selection := new Gtk_Multi_Selection_Record;
   begin
      Gtk.Multi_Selection.Initialize (Self, Model);
      return Self;
   end Gtk_Multi_Selection_New;
   ...
   procedure Gtk_New
      (Self  : out Gtk_Multi_Selection;
       Model : Glib.List_Model.Glist_Model)
   is
   begin
      Self := new Gtk_Multi_Selection_Record;
      Gtk.Multi_Selection.Initialize (Self, Model);
   end Gtk_New;
   ...
   procedure Initialize
      (Self  : not null access Gtk_Multi_Selection_Record'Class;
       Model : Glib.List_Model.Glist_Model)
   is
      function Internal
         (Model : Glib.List_Model.Glist_Model) return System.Address;
      pragma Import (C, Internal, "gtk_multi_selection_new");
   begin
   ...
   function Get_Model
      (Self : not null access Gtk_Multi_Selection_Record)
       return Glib.List_Model.Glist_Model
   is
      function Internal
         (Self : System.Address) return Glib.List_Model.Glist_Model;
      pragma Import (C, Internal, "gtk_multi_selection_get_model");
   begin
   ...
   is
      procedure Internal
         (Self  : System.Address;
          Model : Glib.List_Model.Glist_Model);
      pragma Import (C, Internal, "gtk_multi_selection_set_model");
   begin
   ...
   function Get_Item_Type
      (Self : not null access Gtk_Multi_Selection_Record) return GType
   is
   ...
   function Get_N_Items
      (Self : not null access Gtk_Multi_Selection_Record) return Guint
   is
   ...
   function Select_All
      (Self : not null access Gtk_Multi_Selection_Record) return Boolean
   is
