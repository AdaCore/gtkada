...
package body Gtk.Multi_Sorter is

   package Type_Conversion_Gtk_Multi_Sorter is new Glib.Type_Conversion_Hooks.Hook_Registrator
     (Get_Type'Access, Gtk_Multi_Sorter_Record);
   pragma Unreferenced (Type_Conversion_Gtk_Multi_Sorter);

   --------------------------
   -- Gtk_Multi_Sorter_New --
   --------------------------

   function Gtk_Multi_Sorter_New return Gtk_Multi_Sorter is
      Self : constant Gtk_Multi_Sorter := new Gtk_Multi_Sorter_Record;
   begin
      Gtk.Multi_Sorter.Initialize (Self);
      return Self;
   end Gtk_Multi_Sorter_New;

   -------------
   -- Gtk_New --
   -------------

   procedure Gtk_New (Self : out Gtk_Multi_Sorter) is
   begin
      Self := new Gtk_Multi_Sorter_Record;
      Gtk.Multi_Sorter.Initialize (Self);
   end Gtk_New;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_multi_sorter_new");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_multi_sorter_append");
   begin
      Internal (Get_Object (Self), Get_Object (Sorter));
   end Append;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_multi_sorter_remove");
   begin
