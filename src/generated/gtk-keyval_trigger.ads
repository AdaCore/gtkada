...
package Gtk.Keyval_Trigger is

   type Gtk_Keyval_Trigger_Record is new Gtk_Shortcut_Trigger_Record with null record;
   type Gtk_Keyval_Trigger is access all Gtk_Keyval_Trigger_Record'Class;
   ...
   pragma Import (C, Get_Type, "gtk_keyval_trigger_get_type");
   ...
   Modifiers_Property : constant Gdk.Enums.Property_Gdk_Modifier_Type;
   --  Type: Gdk.Enums.Gdk_Modifier_Type
   --  The key modifiers for the trigger.

private
   Modifiers_Property : constant Gdk.Enums.Property_Gdk_Modifier_Type :=
     Gdk.Enums.Build ("modifiers");
   Keyval_Property : constant Glib.Properties.Property_Uint :=
