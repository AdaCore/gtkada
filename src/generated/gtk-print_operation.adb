...
package body Gtk.Print_Operation is
   ...
   is
      function Internal
         (Self : System.Address) return Gtk.Enums.Gtk_Print_Status;
   ...
   is
      ...
      Tmp_Return : Gtk_Print_Operation_Result;
   begin
      Tmp_Return := Internal (Get_Object (Self), Action, Get_Object_Or_Null (GObject (Parent)), Acc_Error'Access);
      Error := Acc_Error;
      return Tmp_Return;
      -- FIXME;
   end Run;
   ...
   begin
      return Internal (Get_Object (Self), Page_Nr) /= 0;
   end Is_Selected;
   ...
   procedure Render_Page
      (Self    : not null access Gtk_Print_Operation_Record;
       Page_Nr : Glib.Gint)
   is
      procedure Internal (Self : System.Address; Page_Nr : Glib.Gint);
