...
--  entry to edit the text, `GtkCellRendererCombo` offers a `GtkComboBox`
--  widget to edit the text. The values to display in the combo box are taken
--  from the tree model specified in the `GtkCellRendererCombo`:model property.
--
...
--  `GtkCellRendererCombo`:text-column property. Further properties of the
--  combo box can be set in a handler for the
--  `GtkCellRenderer::editing-started` signal.
--
