...
package body Gdk.Monitor is
   ...
   is
      ...
      pragma Import (C, Internal, "gdk_monitor_get_connector");
   begin
   ...
   is
      function Internal
         (Self : System.Address) return Gtkada.Types.Chars_Ptr;
      pragma Import (C, Internal, "gdk_monitor_get_description");
   begin
      return Gtkada.Bindings.Value_Allowing_Null (Internal (Get_Object (Self)));
   end Get_Description;
   ...
   is
      ...
      pragma Import (C, Internal, "gdk_monitor_get_scale");
   begin
      return Internal (Get_Object (Self));
   end Get_Scale;
   ...
   is
      ...
      pragma Import (C, Internal, "gdk_monitor_is_valid");
   begin
