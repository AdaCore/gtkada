...
package body Glib.File_IO_Stream is

   procedure C_G_File_Io_Stream_Query_Info_Async
      (Self        : System.Address;
   ...
   pragma Import (C, C_G_File_Io_Stream_Query_Info_Async, "g_file_io_stream_query_info_async");
   ...
   package Type_Conversion_Gfile_Iostream is new Glib.Type_Conversion_Hooks.Hook_Registrator
     (Get_Type'Access, Gfile_Iostream_Record);
   pragma Unreferenced (Type_Conversion_Gfile_Iostream);
   ...
   is
      ...
      pragma Import (C, Internal, "g_file_io_stream_get_etag");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "g_file_io_stream_query_info");
   ...
   begin
      if Callback = null then
         C_G_File_Io_Stream_Query_Info_Async (Get_Object (Self), Tmp_Attributes, Io_Priority, Get_Object_Or_Null (GObject (Cancellable)), System.Null_Address, System.Null_Address);
         Free (Tmp_Attributes);
      else
         C_G_File_Io_Stream_Query_Info_Async (Get_Object (Self), Tmp_Attributes, Io_Priority, Get_Object_Or_Null (GObject (Cancellable)), Internal_Gasync_Ready_Callback'Address, To_Address (Callback));
         Free (Tmp_Attributes);
      end if;
   ...
   is
      ...
      pragma Import (C, Internal, "g_file_io_stream_query_info_finish");
      Stub_Gfile_Info : Glib.File_Info.Gfile_Info_Record;
   begin
