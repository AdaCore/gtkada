...
package body Gtk.Cell_Renderer is
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_cell_renderer_get_is_expanded");
   begin
   ...
   is
      function Internal (Cell : System.Address) return Glib.Gboolean;
      pragma Import (C, Internal, "gtk_cell_renderer_get_is_expander");
   begin
      return Internal (Get_Object (Cell)) /= 0;
   end Get_Is_Expander;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_cell_renderer_set_is_expanded");
   begin
      Internal (Get_Object (Cell), Boolean'Pos (Is_Expanded));
   end Set_Is_Expanded;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_cell_renderer_set_is_expander");
   begin
      Internal (Get_Object (Cell), Boolean'Pos (Is_Expander));
   end Set_Is_Expander;
