...
package body Gtk.Column_View_Row is

   package Type_Conversion_Gtk_Column_View_Row is new Glib.Type_Conversion_Hooks.Hook_Registrator
     (Get_Type'Access, Gtk_Column_View_Row_Record);
   pragma Unreferenced (Type_Conversion_Gtk_Column_View_Row);
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_column_view_row_get_accessible_description");
   begin
   ...
   is
      function Internal
         (Self : System.Address) return Gtkada.Types.Chars_Ptr;
      pragma Import (C, Internal, "gtk_column_view_row_get_accessible_label");
   begin
      return Gtkada.Bindings.Value_Allowing_Null (Internal (Get_Object (Self)));
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_column_view_row_get_activatable");
   begin
   ...
   is
      function Internal (Self : System.Address) return Glib.Gboolean;
      pragma Import (C, Internal, "gtk_column_view_row_get_focusable");
   begin
      return Internal (Get_Object (Self)) /= 0;
   end Get_Focusable;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_column_view_row_get_item");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_column_view_row_get_position");
   begin
      return Internal (Get_Object (Self));
   end Get_Position;
   ...
   is
      function Internal (Self : System.Address) return Glib.Gboolean;
      pragma Import (C, Internal, "gtk_column_view_row_get_selectable");
   begin
      return Internal (Get_Object (Self)) /= 0;
   end Get_Selectable;
   ...
   is
      function Internal (Self : System.Address) return Glib.Gboolean;
      pragma Import (C, Internal, "gtk_column_view_row_get_selected");
   begin
      return Internal (Get_Object (Self)) /= 0;
   end Get_Selected;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_column_view_row_set_accessible_description");
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_column_view_row_set_accessible_label");
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_column_view_row_set_activatable");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_column_view_row_set_focusable");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_column_view_row_set_selectable");
   begin
