...
package body Gtk.Cell_Area is
   ...
   pragma Obsolescent (C_Gtk_Cell_Area_Foreach);
   ...
   pragma Obsolescent (Internal_Gtk_Cell_Alloc_Callback);
   ...
   function Internal_Gtk_Cell_Callback
      (Renderer : System.Address;
       Data     : System.Address) return Glib.Gboolean;
   pragma Obsolescent (Internal_Gtk_Cell_Callback);
   ...
   procedure Clear (Self : not null access Gtk_Cell_Area_Record) is
