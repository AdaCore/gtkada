...
--  with gdk_display_get_monitors and to find particular monitors with
--  Gdk.Display.Get_Primary_Monitor or Gdk.Display.Get_Monitor_At_Window.
--
...
package Gdk.Monitor is
   ...
   --  Since: gtk+ 3.22
   --  "geometry": a Gdk.Rectangle.Gdk_Rectangle to be filled wiht the monitor
   --  geometry

   function Get_Height_Mm
      (Self : not null access Gdk_Monitor_Record) return Gint;
