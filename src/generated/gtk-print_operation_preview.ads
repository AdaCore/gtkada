...
--  [signalGtk.PrintOperation::preview] signal by [classGtk.PrintOperation].
...
package Gtk.Print_Operation_Preview is
   ...
   procedure End_Preview (Self : Gtk_Print_Operation_Preview);
   ...
   --  [signalGtk.PrintOperation::preview] handler together with Preview.
   ...
   --  [methodGtk.PrintContext.set_cairo_context].
   -- 
   --  Callback parameters:
   ...
   type Virtual_End_Preview is access procedure (Self : Gtk_Print_Operation_Preview);
   ...
   type Virtual_Render_Page is access procedure (Self : Gtk_Print_Operation_Preview; Page_Nr : Glib.Gint);
