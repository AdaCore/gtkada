...
package body Gtk.Stack_Page is

   package Type_Conversion_Gtk_Stack_Page is new Glib.Type_Conversion_Hooks.Hook_Registrator
     (Get_Type'Access, Gtk_Stack_Page_Record);
   pragma Unreferenced (Type_Conversion_Gtk_Stack_Page);
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_stack_page_get_child");
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_stack_page_get_icon_name");
   begin
   ...
   is
      function Internal
         (Self : System.Address) return Gtkada.Types.Chars_Ptr;
      pragma Import (C, Internal, "gtk_stack_page_get_name");
   begin
      return Gtkada.Bindings.Value_Allowing_Null (Internal (Get_Object (Self)));
   end Get_Name;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_stack_page_get_needs_attention");
   begin
      return Internal (Get_Object (Self)) /= 0;
   end Get_Needs_Attention;
   ...
   is
      function Internal
         (Self : System.Address) return Gtkada.Types.Chars_Ptr;
      pragma Import (C, Internal, "gtk_stack_page_get_title");
   begin
      return Gtkada.Bindings.Value_Allowing_Null (Internal (Get_Object (Self)));
   end Get_Title;
   ...
   is
      function Internal (Self : System.Address) return Glib.Gboolean;
      pragma Import (C, Internal, "gtk_stack_page_get_use_underline");
   begin
      return Internal (Get_Object (Self)) /= 0;
   ...
   is
      function Internal (Self : System.Address) return Glib.Gboolean;
      pragma Import (C, Internal, "gtk_stack_page_get_visible");
   begin
      return Internal (Get_Object (Self)) /= 0;
   end Get_Visible;
   ...
   is
      procedure Internal
         (Self    : System.Address;
          Setting : Gtkada.Types.Chars_Ptr);
      pragma Import (C, Internal, "gtk_stack_page_set_icon_name");
      Tmp_Setting : Gtkada.Types.Chars_Ptr := New_String (Setting);
   begin
      Internal (Get_Object (Self), Tmp_Setting);
      Free (Tmp_Setting);
   end Set_Icon_Name;
   ...
   is
      procedure Internal
         (Self    : System.Address;
          Setting : Gtkada.Types.Chars_Ptr);
      pragma Import (C, Internal, "gtk_stack_page_set_name");
      Tmp_Setting : Gtkada.Types.Chars_Ptr := New_String (Setting);
   begin
      Internal (Get_Object (Self), Tmp_Setting);
      Free (Tmp_Setting);
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_stack_page_set_needs_attention");
   begin
      Internal (Get_Object (Self), Boolean'Pos (Setting));
   end Set_Needs_Attention;
   ...
   is
      procedure Internal
         (Self    : System.Address;
          Setting : Gtkada.Types.Chars_Ptr);
      pragma Import (C, Internal, "gtk_stack_page_set_title");
      Tmp_Setting : Gtkada.Types.Chars_Ptr := New_String (Setting);
   begin
      Internal (Get_Object (Self), Tmp_Setting);
      Free (Tmp_Setting);
   ...
   is
      procedure Internal (Self : System.Address; Setting : Glib.Gboolean);
      pragma Import (C, Internal, "gtk_stack_page_set_use_underline");
   begin
      Internal (Get_Object (Self), Boolean'Pos (Setting));
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_stack_page_set_visible");
   begin
