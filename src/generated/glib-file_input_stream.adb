...
package body Glib.File_Input_Stream is
   ...
   procedure C_G_File_Input_Stream_Query_Info_Async
      (Self        : System.Address;
   ...
   pragma Import (C, C_G_File_Input_Stream_Query_Info_Async, "g_file_input_stream_query_info_async");
   ...
   package Type_Conversion_Gfile_Input_Stream is new Glib.Type_Conversion_Hooks.Hook_Registrator
     (Get_Type'Access, Gfile_Input_Stream_Record);
   pragma Unreferenced (Type_Conversion_Gfile_Input_Stream);
   ...
   begin
      if Callback = null then
         C_G_File_Input_Stream_Query_Info_Async (Get_Object (Self), Tmp_Attributes, Io_Priority, Get_Object_Or_Null (GObject (Cancellable)), System.Null_Address, System.Null_Address);
         Free (Tmp_Attributes);
      else
         C_G_File_Input_Stream_Query_Info_Async (Get_Object (Self), Tmp_Attributes, Io_Priority, Get_Object_Or_Null (GObject (Cancellable)), Internal_Gasync_Ready_Callback'Address, To_Address (Callback));
         Free (Tmp_Attributes);
      end if;
