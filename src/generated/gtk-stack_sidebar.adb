...
package body Gtk.Stack_Sidebar is

   package Type_Conversion_Gtk_Stack_Sidebar is new Glib.Type_Conversion_Hooks.Hook_Registrator
     (Get_Type'Access, Gtk_Stack_Sidebar_Record);
   pragma Unreferenced (Type_Conversion_Gtk_Stack_Sidebar);

   -------------
   -- Gtk_New --
   -------------

   procedure Gtk_New (Self : out Gtk_Stack_Sidebar) is
   begin
      Self := new Gtk_Stack_Sidebar_Record;
      Gtk.Stack_Sidebar.Initialize (Self);
   end Gtk_New;
   ...
   function Gtk_Stack_Sidebar_New return Gtk_Stack_Sidebar is
      Self : constant Gtk_Stack_Sidebar := new Gtk_Stack_Sidebar_Record;
   begin
      Gtk.Stack_Sidebar.Initialize (Self);
      return Self;
   end Gtk_Stack_Sidebar_New;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_stack_sidebar_new");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_stack_sidebar_get_stack");
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_stack_sidebar_set_stack");
   begin
      Internal (Get_Object (Self), Get_Object (Stack));
   end Set_Stack;
