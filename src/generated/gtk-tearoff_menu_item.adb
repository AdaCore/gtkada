...
package body Gtk.Tearoff_Menu_Item is
   ...
   package Type_Conversion_Gtk_Tearoff_Menu_Item is new Glib.Type_Conversion_Hooks.Hook_Registrator
     (Get_Type'Access, Gtk_Tearoff_Menu_Item_Record);
   pragma Unreferenced (Type_Conversion_Gtk_Tearoff_Menu_Item);
   ...
   is
      ...
      Stub_2665 : Gtk.Action.Gtk_Action_Record;
   begin
      return Gtk.Action.Gtk_Action (Get_User_Data (Internal (Get_Object (Self)), Stub_2665));
