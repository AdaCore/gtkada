...
package body Gtk.Cell_Layout is
   ...
   begin
      Internal (Self, Get_Object (Cell), Tmp_Attribute, Column);
      Free (Tmp_Attribute);
   end Add_Attribute;
   ...
   procedure Clear_Attributes
      (Self : Gtk_Cell_Layout;
       Cell : not null access Gtk.Cell_Renderer.Gtk_Cell_Renderer_Record'Class)
   is
      procedure Internal (Self : Gtk_Cell_Layout; Cell : System.Address);
      pragma Import (C, Internal, "gtk_cell_layout_clear_attributes");
   begin
      Internal (Self, Get_Object (Cell));
   ...
   is
      function Internal (Self : Gtk_Cell_Layout) return System.Address;
      pragma Import (C, Internal, "gtk_cell_layout_get_cells");
      Tmp_Return : Gtk.Cell_Renderer.Cell_Renderer_List.Glist;
   begin
      Gtk.Cell_Renderer.Cell_Renderer_List.Set_Object (Tmp_Return, Internal (Self));
      return Tmp_Return;
   end Get_Cells;
   ...
   begin
      Internal (Self, Get_Object (Cell), Boolean'Pos (Expand));
   end Pack_End;
   ...
   begin
      Internal (Self, Get_Object (Cell), Position);
   end Reorder;
   ...
   begin
      if Func = null then
         C_Gtk_Cell_Layout_Set_Cell_Data_Func (Self, Get_Object (Cell), System.Null_Address, System.Null_Address, System.Null_Address);
      else
         C_Gtk_Cell_Layout_Set_Cell_Data_Func (Self, Get_Object (Cell), Internal_Gtk_Cell_Layout_Data_Func'Address, To_Address (Func), System.Null_Address);
      end if;
   ...
   package body Set_Cell_Data_Func_User_Data is
      ...
      begin
         if Func = null then
            C_Gtk_Cell_Layout_Set_Cell_Data_Func (Self, Get_Object (Cell), System.Null_Address, System.Null_Address, Users.Free_Data'Address);
         else
            D := Users.Build (To_Address (Func), Func_Data);
            C_Gtk_Cell_Layout_Set_Cell_Data_Func (Self, Get_Object (Cell), Internal_Cb'Address, D, Users.Free_Data'Address);
         end if;
      end Set_Cell_Data_Func;
