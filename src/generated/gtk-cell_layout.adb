...
package body Gtk.Cell_Layout is
   ...
   begin
      if Func = null then
         ...
         C_Gtk_Cell_Layout_Set_Cell_Data_Func (Cell_Layout, Get_Object (Cell), Internal_Cell_Data_Func'Address, To_Address (Func), System.Null_Address);
      end if;
   ...
   package body Set_Cell_Data_Func_User_Data is
      ...
      begin
         if Func = null then
            ...
            C_Gtk_Cell_Layout_Set_Cell_Data_Func (Cell_Layout, Get_Object (Cell), Internal_Cb'Address, Users.Build (To_Address (Func), Func_Data), Users.Free_Data'Address);
         end if;
      end Set_Cell_Data_Func;
