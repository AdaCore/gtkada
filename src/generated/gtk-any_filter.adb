...
package body Gtk.Any_Filter is

   package Type_Conversion_Gtk_Any_Filter is new Glib.Type_Conversion_Hooks.Hook_Registrator
     (Get_Type'Access, Gtk_Any_Filter_Record);
   pragma Unreferenced (Type_Conversion_Gtk_Any_Filter);

   ------------------------
   -- Gtk_Any_Filter_New --
   ------------------------

   function Gtk_Any_Filter_New return Gtk_Any_Filter is
      Self : constant Gtk_Any_Filter := new Gtk_Any_Filter_Record;
   begin
      Gtk.Any_Filter.Initialize (Self);
      return Self;
   end Gtk_Any_Filter_New;

   -------------
   -- Gtk_New --
   -------------

   procedure Gtk_New (Self : out Gtk_Any_Filter) is
   begin
      Self := new Gtk_Any_Filter_Record;
      Gtk.Any_Filter.Initialize (Self);
   end Gtk_New;
   ...
   procedure Initialize (Self : not null access Gtk_Any_Filter_Record'Class) is
      function Internal return System.Address;
      pragma Import (C, Internal, "gtk_any_filter_new");
   begin
