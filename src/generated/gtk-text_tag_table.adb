...
package body Gtk.Text_Tag_Table is
   ...
   begin
      return Internal (Get_Object (Table), Get_Object (Tag)) /= 0;
   end Add;
   ...
   package body Foreach_User_Data is
      ...
      --  A function used with Gtk.Text_Tag_Table.Foreach, to iterate over
      --  every `GtkTextTag` inside a `GtkTextTagTable`.
      --  @param Tag the `GtkTextTag`
      --  @param Data data passed to Gtk.Text_Tag_Table.Foreach
