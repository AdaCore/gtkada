...
package body Gtk.Adjustment is
   ...
   is
      Self : constant Gtk_Adjustment := new Gtk_Adjustment_Record;
   begin
      Gtk.Adjustment.Initialize (Self, Value, Lower, Upper, Step_Increment, Page_Increment, Page_Size);
      return Self;
   ...
   is
   begin
      Self := new Gtk_Adjustment_Record;
      Gtk.Adjustment.Initialize (Self, Value, Lower, Upper, Step_Increment, Page_Increment, Page_Size);
   end Gtk_New;
   ...
   begin
      if not Self.Is_Created then
         Set_Object (Self, Internal (Value, Lower, Upper, Step_Increment, Page_Increment, Page_Size));
      end if;
   end Initialize;
   ...
   begin
      Internal (Get_Object (Self), Lower, Upper);
   end Clamp_Page;
   ...
   begin
      Internal (Get_Object (Self), Value, Lower, Upper, Step_Increment, Page_Increment, Page_Size);
   end Configure;
   ...
   procedure Set_Lower
      (Self  : not null access Gtk_Adjustment_Record;
       Lower : Gdouble)
   is
      procedure Internal (Self : System.Address; Lower : Gdouble);
      pragma Import (C, Internal, "gtk_adjustment_set_lower");
   begin
      Internal (Get_Object (Self), Lower);
   end Set_Lower;
   ...
   procedure Set_Page_Increment
      (Self           : not null access Gtk_Adjustment_Record;
       Page_Increment : Gdouble)
   is
      procedure Internal (Self : System.Address; Page_Increment : Gdouble);
      pragma Import (C, Internal, "gtk_adjustment_set_page_increment");
   begin
      Internal (Get_Object (Self), Page_Increment);
   ...
   procedure Set_Page_Size
      (Self      : not null access Gtk_Adjustment_Record;
       Page_Size : Gdouble)
   is
      procedure Internal (Self : System.Address; Page_Size : Gdouble);
      pragma Import (C, Internal, "gtk_adjustment_set_page_size");
   begin
      Internal (Get_Object (Self), Page_Size);
   end Set_Page_Size;
   ...
   procedure Set_Step_Increment
      (Self           : not null access Gtk_Adjustment_Record;
       Step_Increment : Gdouble)
   is
      procedure Internal (Self : System.Address; Step_Increment : Gdouble);
      pragma Import (C, Internal, "gtk_adjustment_set_step_increment");
   begin
      Internal (Get_Object (Self), Step_Increment);
   ...
   procedure Set_Upper
      (Self  : not null access Gtk_Adjustment_Record;
       Upper : Gdouble)
   is
      procedure Internal (Self : System.Address; Upper : Gdouble);
      pragma Import (C, Internal, "gtk_adjustment_set_upper");
   begin
      Internal (Get_Object (Self), Upper);
   end Set_Upper;
