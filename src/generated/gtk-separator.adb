...
package body Gtk.Separator is
   ...
   is
   begin
      Self := new Gtk_Separator_Record;
      Gtk.Separator.Initialize (Self, Orientation);
   end Gtk_New;
   ...
   is
      Self : constant Gtk_Separator := new Gtk_Separator_Record;
   begin
      Gtk.Separator.Initialize (Self, Orientation);
      return Self;
   ...
   begin
      if not Self.Is_Created then
         Set_Object (Self, Internal (Orientation));
      end if;
   end Initialize;
