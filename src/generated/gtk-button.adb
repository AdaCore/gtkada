...
package body Gtk.Button is
   ...
   begin
      Gtk.Button.Initialize_From_Icon_Name (Button, Icon_Name);
      return Button;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_button_get_can_shrink");
   begin
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_button_get_child");
   ...
   is
      function Internal (Button : System.Address) return Glib.Gboolean;
      pragma Import (C, Internal, "gtk_button_get_has_frame");
   begin
      return Internal (Get_Object (Button)) /= 0;
   end Get_Has_Frame;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_button_get_icon_name");
   begin
   ...
   is
      procedure Internal
         (Button     : System.Address;
          Can_Shrink : Glib.Gboolean);
      pragma Import (C, Internal, "gtk_button_set_can_shrink");
   begin
      Internal (Get_Object (Button), Boolean'Pos (Can_Shrink));
   end Set_Can_Shrink;
   ...
   is
      procedure Internal (Button : System.Address; Child : System.Address);
      pragma Import (C, Internal, "gtk_button_set_child");
   begin
      Internal (Get_Object (Button), Get_Object_Or_Null (GObject (Child)));
   end Set_Child;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_button_set_has_frame");
   begin
      Internal (Get_Object (Button), Boolean'Pos (Has_Frame));
   end Set_Has_Frame;
   ...
   is
      ...
      pragma Import (C, Internal, "gtk_button_set_icon_name");
      Tmp_Icon_Name : Gtkada.Types.Chars_Ptr := New_String (Icon_Name);
   begin
