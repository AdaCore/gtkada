...
package body Gtk.Extra.Sheet is
   ...
   begin
      return Boolean'Val
        (Internal (Get_Object (Sheet), Row, Column, A'Address));
   end Get_Cell_Area;
   ...
   function Get_Range (Sheet : access Gtk_Sheet_Record)
