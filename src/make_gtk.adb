...
with Gtk.Cell_Renderer_Combo;
with Gtk.Cell_Renderer_Progress;
...
with Gtk.Extra.Plot_Canvas.Pixmap;
with Gtk.Extra.Plot_Canvas.Line;
with Gtk.Extra.Plot_Canvas.Rectangle;
with Gtk.Extra.Plot_Canvas.Ellipse;
with Gtk.Extra.Plot_Canvas.Plot;
with Gtk.Extra.Plot_Canvas.Text;
