...
package Gtk.Tree_Model_Sort is
   ...
   --  Returns the model the Gtk_Tree_Model_Sort is sorting.
   ...
   --  Sets Sort_Iter to point to the row in Tree_Model_Sort that
   ...
   function Convert_Path_To_Child_Path
     (Tree_Model_Sort : access Gtk_Tree_Model_Sort_Record;
      ...
      return Gtk.Tree_Model.Gtk_Tree_Path;
   --  Converts Sort_Path to a path on the child model of Tree_Model_Sort.
