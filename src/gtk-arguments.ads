...
package Gtk.Arguments is
   ...
   function Unchecked_To_Gtk_State_Flags is new
   ...
   function Unchecked_To_Gdk_Modifier_Type is new
     Glib.Values.Unsafe_Enum_Nth (Gdk.Enums.Gdk_Modifier_Type);
   ...
   function Unchecked_To_Cairo_Context
     (Args : Glib.Values.C_GValues; Num : Guint) return Cairo.Cairo_Context;
