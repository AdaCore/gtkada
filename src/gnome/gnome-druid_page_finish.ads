...
package Gnome.Druid_Page_Finish is

   type Gnome_Druid_Page_Finish_Record is new
     Gnome.Druid_Page.Gnome_Druid_Page_Record with private;
   type Gnome_Druid_Page_Finish is
     access all Gnome_Druid_Page_Finish_Record'Class;
   ...
   procedure Gnome_New (Widget : out Gnome_Druid_Page_Finish);

   procedure Initialize (Widget : access Gnome_Druid_Page_Finish_Record'Class);
   --  Internal initialization function.
   --  See the section "Creating your own widgets" in the documentation.
...
private
   ...
   pragma Import (C, Get_Type, "gnome_druid_page_finish_get_type");
