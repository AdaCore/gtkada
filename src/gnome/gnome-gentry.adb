...
package body Gnome.GEntry is
   ...
   procedure Initialize (Widget     : access Gnome_GEntry_Record'Class;
                         History_Id : String)
   is
      function Internal (History_Id : String)
   ...
   is
      procedure Internal (Gentry : System.Address);
      pragma Import (C, Internal, "gnome_entry_load_history");
   begin
      Internal (Get_Object (Gentry));
   end Entry_Load_History;
   ...
   is
      procedure Internal (Gentry : System.Address);
      pragma Import (C, Internal, "gnome_entry_save_history");
   begin
      Internal (Get_Object (Gentry));
   end Entry_Save_History;
