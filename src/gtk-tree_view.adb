...
package body Gtk.Tree_View is
   ...
   begin
      ...
      --  ??? is the GObject properly initialized ?
   ...
   procedure Initialize
     (Widget : access Gtk_Tree_View_Record'Class;
      Model  : access Gtk.Tree_Model.Gtk_Tree_Model_Record'Class)
   is
      function Internal (Model  : System.Address)
   ...
   function Get_Model (Tree_View : access Gtk_Tree_View_Record)
   ...
   function Get_Selection (Tree_View : access Gtk_Tree_View_Record)
   ...
   function Get_Hadjustment (Tree_View : access Gtk_Tree_View_Record)
   ...
   function Get_Vadjustment (Tree_View : access Gtk_Tree_View_Record)
                             return Gtk.Adjustment.Gtk_Adjustment
   is
      function Internal (Tree_View : System.Address)
                         return System.Address;
   ...
   function Get_Headers_Visible (Tree_View : access Gtk_Tree_View_Record)
                                 return Boolean
   is
      function Internal (Tree_View : System.Address)
                         return Gint;
   ...
   function Get_Rules_Hint (Tree_View : access Gtk_Tree_View_Record)
                            return Boolean
   is
      function Internal (Tree_View : System.Address)
                        return Gint;
...
--    end Insert_Column_With_Data_Func;
   ...
   function Get_Columns (Tree_View : access Gtk_Tree_View_Record)
...
--    end Map_Expanded_Rows;
   ...
   function Get_Reorderable (Tree_View : access Gtk_Tree_View_Record)
                             return Boolean
   is
      function Internal (Tree_View : System.Address)
                         return Gint;
   ...
   is
      function Internal
        (Tree_View : System.Address;
         ...
         Path      : System.Address;
         Column    : System.Address;
         Cell_X    : System.Address;
         Cell_Y    : System.Address)
         return Gint;
      pragma Import (C, Internal, "gtk_tree_view_get_path_at_pos");
   begin
      Row_Found := Boolean'Val (Internal (Get_Object (Tree_View),
                                          Window,
                                          X,
                                          Y,
                                          Path.all'Address,
...
--                 N_Targets,
--                 Gdk_Drag_Action'Pos (Actions),
--                 Gtk_Tree_View_Droppable_Func'Pos (Location_Droppable_Func),
--                 User_Data);
...
--       Internal (Get_Object (Tree_View),
--                 Path.all'Address,
--                 Gtk_Tree_View_Drop_Position'Pos (Pos));
...
--    end Get_Dest_Row_At_Pos;
   ...
   begin
      return Gdk.Pixmap.Gdk_Pixmap (Internal (Get_Object (Tree_View),
                                              Path.all'Address));
   ...
   function Get_Enable_Search (Tree_View : access Gtk_Tree_View_Record)
                               return Boolean
   is
      function Internal (Tree_View : System.Address)
                         return Gint;
   ...
   function Get_Search_Column (Tree_View : access Gtk_Tree_View_Record)
                               return Gint
   is
      function Internal (Tree_View : System.Address)
                         return Gint;
