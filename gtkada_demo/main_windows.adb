...
package body Main_Windows is
   ...
   --  TRANSITION: the rest of the original body is preserved below as
   --  comments. Uncomment and re-wire each piece as the corresponding
   --  widgets and helpers become available.
   --
