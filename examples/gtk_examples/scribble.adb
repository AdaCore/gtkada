...
procedure Scribble is
   ...
   package Configured is new Gtk.Handlers.Callback
   ...
   procedure Configure_Event (Drawing_Area : access Gtk_Drawing_Area_Record'Class) is
      Win: GDK_Window;
      Width: Gint;
      Height: Gint;
      Sty : Gtk.Style.Gtk_Style:= Gtk.Style.Get_Style (Drawing_Area);
      Gc: Gdk_GC;
   ...
   procedure Expose_Event (Drawing_Area : access Gtk_Drawing_Area_Record'Class;
   ...
   procedure Draw_Brush (Widget : access Gtk_Drawing_Area_Record'Class;
                         X,Y: Gint) is
      Message: String:="Moo";
      Height, Width: Gint;
      Cx, Cy: Gint;
...
begin
   ...
   Destroyed.Object_Connect (Button, "clicked", Destroyed.To_Marshaller (Bye'Access),
                             Slot_Object => Window);
