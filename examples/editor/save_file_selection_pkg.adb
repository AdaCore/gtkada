...
begin
   ...
   Cb_Id := Button_Callback.Connect
     (Save_File_Selection.Ok_Button3, "clicked", On_Save_Filesel_Ok_Button_Clicked'Access);
   ...
   Cb_Id := Button_Callback.Connect
     (Save_File_Selection.Cancel_Button3, "clicked", On_Save_Filesel_Cancel_Button_Clicked'Access);
