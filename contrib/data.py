...
naming.girname_to_ctype = {
    ...
    "Gdk.EventTouchpadSwipe":  "GdkEventTouchpadSwipe*",
    "Gdk.EventTouchpadPinch":  "GdkEventTouchpadPinch*",
    "Gdk.EventPadButton":  "GdkEventPadButton*",
    "Gdk.EventPadGroupMode":  "GdkEventPadGroupMode*",
